      ...
      >
        <div className="w-full flex flex-col items-center space-y-4 sm:items-center">
          ...
          <Transition
            ...
            leaveTo="opacity-0"
          >
            <div className="max-w-sm w-full bg-white/80 shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden">
              <div className="p-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4 flex-shrink-0 flex">
                    ...
                    >
                      ...
                      <SquareX className="h-5 w-5" aria-hidden="true" />
                    </button>
                  </div>
                </div>
              </div>
